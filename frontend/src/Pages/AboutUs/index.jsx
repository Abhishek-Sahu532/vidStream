  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <main className="container mx-auto px-4 py-8">
        <section className="mb-8">
          <div className="md:flex items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h2 className="text-3xl font-bold text-primarybg mb-3">
                Welcome to VidStream
              </h2>
              <p className="text-lg text-secondarybg leading-relaxed">
            ...
            <div className="md:w-1/2">
              <div className="relative">
                ...
                <Link to='/'> 
                <button className="bg-primarybg hover:bg-secondarybg text-white font-bold py-2 px-4 rounded">
                    Explore
                  </button>
                </Link>
        ...
        <section className="mb-8">
          <h2 className="text-3xl font-bold text-primarybg">Our Story</h2>
          <div className="md:flex items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <p className="text-lg text-secondarybg leading-relaxed mb-4">
            ...
            <div className="md:w-1/2">
              <div className="relative ">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-50 flex items-center justify-center">
                  <h3 className="text-secondarybg hover:text-white text-2xl font-bold">Our Journey</h3>
                </div>
              </div>
            </div>
          </div>
        ...
        <section className="mb-8">
          <div className="md:flex items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h2 className="text-3xl font-bold text-primarybg mb-4">
                Empowering Creators
              </h2>
              <p className="text-lg text-secondarybg leading-relaxed mb-4">
        ...
        <section className="text-center">
          <h2 className="text-3xl font-bold text-secondarybg mb-4">
            Join the Movement
          </h2>
          <p className="text-lg text-primarybg  leading-relaxed mb-8">
          ...
          <Link to='/signin'>
          <button className="text-primarybg bg-none border border-b-blue-gray-800 font-bold py-2 px-4 rounded ">
            Sign Up Now
          </button></Link>
        </section>
      </main>
