...
const ChatSidebar = () => {
  return (
    <div className="container overflow-hidden shadow-lg rounded-lg h-screen">
      {/* <!-- Chatting --> */}
      <div className="flex flex-row justify-between bg-white">
        {/* <!-- chat list --> */}
        <div className="flex flex-col w-1/5 border-r-2 overflow-y-auto  h-screen">
          {/* <!-- search compt --> */}
          <div className="border-b-2 py-4 px-2 fixed ">
            <input
              type="text"
              placeholder="search chatting"
              className="py-2 px-2 border-2 border-gray-200 rounded-2xl w-full overflow-hidden"
            />
          </div>
          {/* <!-- end search compt --> */}
          {/* <!-- user list --> sidebar */}
          <div className="flex flex-row py-4 px-2 justify-center items-center border-b-2 mt-20 ">
            <div className="w-1/4">
              <img
                ...
                >
                  ...
                  >
                    <path
                      ...
                      strokeLinejoin="round"
                      strokeWidth="2"
                      d="M14.752 11.168l-6.586-6.586a2 2 0 00-2.828 2.828L9.172 11H3a1 1 0 000 2h6.172l-4.586 4.586a2 2 0 002.828 2.828l6.586-6.586a2 2 0 000-2.828z"
                    ></path>
                  </svg>
                </button>
              </div>
