import { CREATE_SUBSCRIBER_REQUEST,
    CREATE_SUBSCRIBER_SUCCESS,
    CREATE_SUBSCRIBER_FAIL,
    CREATE_SUBSCRIBER_RESET,
    DELETE_SUBSCRIBER_REQUEST,DELETE_SUBSCRIBER_SUCCESS, DELETE_SUBSCRIBER_FAIL, DELETE_SUBSCRIBER_RESET,
    CLEAR_ERRORS } from "../constaints/SubscriberConstaints";
